...
const STAFF = [
  ...
  { id: "vishnu", name: "Vishnu", role: "Asst. Operation Manager" },
      ...
      <div className="relative z-10 w-[420px] bg-zinc-950 border border-zinc-800 p-12">
        <div className="border-b border-zinc-800 pb-6 mb-8">
          ...
          <p className="mt-1 text-[11px] font-mono text-zinc-500 uppercase tracking-widest">
            Brownie Heaven // Accountability System
          </p>
        </div>
        ...
        <div className="space-y-5">
          ...
          <button
            onClick={handleLogin}
            className="w-full bg-yellow-400 text-black font-bold tracking-widest text-sm py-3.5 hover:opacity-90 transition-opacity uppercase mt-2"
          >
            Enter System →
          </button>
        </div>
        ...
        <div className="mt-6 p-3 bg-yellow-400/5 border-l-2 border-yellow-400 text-xs text-zinc-400 leading-relaxed">
          <strong className="text-white">DEMO MODE.</strong> Fake login active.
          Real authentication will be wired up when database is connected.
        </div>
      </div>
    </div>
  );
